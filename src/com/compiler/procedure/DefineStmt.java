...
public class DefineStmt {
    ...
    static {
        ...
        stmts.put(3,new Stmt("S","SL"));
        stmts.put(4,new Stmt("S","D"));
        stmts.put(5,new Stmt("D","D,i"));
        stmts.put(6,new Stmt("D","int`i"));
        stmts.put(7,new Stmt("E","E+T"));
        stmts.put(8,new Stmt("E","E-T"));
        ...
        stmts.put(15,new Stmt("L",";"));
        stmts.put(16,new Stmt("L",";S;"));
        stmtList.put("B",new String[]{"S"});
        stmtList.put("S",new String[]{"SL","E","A","D"});
        stmtList.put("E",new String[]{"E+T","E-T"});
